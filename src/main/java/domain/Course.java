...
public class Course extends BaseEntity {
    ...
    public void setName(String name) throws InvalidValueException {
        if (name != null && name.length() > 1) {
            ...
            throw new InvalidValueException("Kurs-Name muss mindestens 2 Zeichen lang sein!");
        }
    }
    ...
    public void setDescription(String description) throws InvalidValueException {
        if (description != null && description.length() > 10) {
            ...
            throw new InvalidValueException("Kurs-Beschreibung muss mindestens 10 Zeichen lang sein!");
        }
    }
    ...
    public void setCourseType(CourseType courseType) throws InvalidValueException {
        if (courseType != null) {
            ...
            throw new InvalidValueException("Kurs-Typ dar nicht null / leer sein!");
        }
    }
